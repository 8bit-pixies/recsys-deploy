...
REC_MODEL = "notebooks/model_standard/model.joblib"
FASTTEST_MODEL = "notebooks/model_standard/lid.176.ftz"
...
if __name__ == "__main__":
    ...
    joblib.dump(model, "notebooks/model_standard/model.joblib")
    del model

    model_loaded = joblib.load("notebooks/model_standard/model.joblib")
