"""
This is a recreation of MVP pipeline - the purpose is to determine performance metrics
"""
...
REC_MODEL = "notebooks/model_mvp1/model.joblib"
FASTTEST_MODEL = "notebooks/model_mvp1/lid.176.ftz"
...
def preprocess_tags(tag: List[str]):
    # remove punctuation - use bag of tags
    stripped_list = [
        ' '.join(gensim.utils.simple_preprocess(x.replace("_", " ")))
        for x in tag
    ]
...
if __name__ == "__main__":
    ...
    joblib.dump(model, "notebooks/model_mvp1/model.joblib")
    del model

    model_loaded = joblib.load("notebooks/model_mvp1/model.joblib")
